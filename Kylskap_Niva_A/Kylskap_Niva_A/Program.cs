...
namespace Kylskap_Niva_A
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ViewTestHeader("Test 8. \nTest av egenskaperna så att undantag kastas då innertemperaturen och måltemperaturen tilldelas felaktiga värden");
                Cooler test8 = new Cooler(85.8m, 94m, false, true);
                Console.WriteLine();
                ViewErrorMessage("Innertemperaturen är inte i intervallen 0 - 45°C");
            }
            catch (Exception)
            {
            }
